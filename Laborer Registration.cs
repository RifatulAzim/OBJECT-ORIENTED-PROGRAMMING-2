...
namespace WindowsFormsApp5
{
    ...
    public partial class LaborerRegistration : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else { MessageBox.Show("Please Enter All the Fields", "Failure", MessageBoxButtons.OK, MessageBoxIcon.Information); }
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            string query = "update laborertable set laborername=@name ,age= @age, phonenumber=@phoneNumber, job=@job,  picture=@picture where id=@id;";
