...
namespace WindowsFormsApp5
{
    ...
    public partial class LaborerRecruit : Form
    {
        ...
        void BindGridView()
        {
            ...
            {
                query = "select laborername,id, age,rating, job,hiredtimes, picture from laborertable where   (hirerid=null or hirerid='') and  (potentialcustomerid=null or potentialcustomerid='');";
